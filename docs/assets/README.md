...
Images and diagrams used by the documentation pages.

Conventions:

- File names: `kebab-case.png` / `.svg` / `.jpg`.
- Product screenshots are prefixed with the product name (`tiger-studio-inventory.png`).
